...
<html>
  ...
  <body>
  	  ...
  	  <table id="table">
  		...
  		<form name="f1" action="${pageContext.request.contextPath}/front/order/toOrder.action" method="post">
  ...
  <script type="text/javascript">
  	  ...
  	  function _chgDft(obj,id){
  		 ...
  		 var url = path+"/front/address/chgDft.action?id="+id;
  		 window.location.href=url;
  	  }
  	  //删除一个地址
  	  function _del(id){
  		 var url = path+"/front/address/delete.action?id="+id;
  		 window.location.href=url;
  	  }
  	  //确定订单
  	  function _toOrder(){
